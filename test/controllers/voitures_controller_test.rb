...
class VoituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voiture" do
    assert_difference('Voiture.count') do
      post voitures_url, params: { voiture: { climatiseur: @voiture.climatiseur, marque: @voiture.marque, place: @voiture.place, status: @voiture.status, type: @voiture.type, vitesse: @voiture.vitesse } }
    end
  ...
  test "should update voiture" do
    patch voiture_url(@voiture), params: { voiture: { climatiseur: @voiture.climatiseur, marque: @voiture.marque, place: @voiture.place, status: @voiture.status, type: @voiture.type, vitesse: @voiture.vitesse } }
