...
class PaiementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paiement" do
    assert_difference('Paiement.count') do
      post paiements_url, params: { paiement: { accompte: @paiement.accompte, total: @paiement.total } }
    end
  ...
  test "should update paiement" do
    patch paiement_url(@paiement), params: { paiement: { accompte: @paiement.accompte, total: @paiement.total } }
