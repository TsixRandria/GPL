...
class AssurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assurance" do
    assert_difference('Assurance.count') do
      post assurances_url, params: { assurance: { assurance: @assurance.assurance, caution: @assurance.caution, montant: @assurance.montant } }
    end
  ...
  test "should update assurance" do
    patch assurance_url(@assurance), params: { assurance: { assurance: @assurance.assurance, caution: @assurance.caution, montant: @assurance.montant } }
