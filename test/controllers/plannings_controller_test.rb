...
class PlanningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planning" do
    assert_difference('Planning.count') do
      post plannings_url, params: { planning: { date_debut: @planning.date_debut, echeance: @planning.echeance, etat: @planning.etat, titre: @planning.titre } }
    end
  ...
  test "should update planning" do
    patch planning_url(@planning), params: { planning: { date_debut: @planning.date_debut, echeance: @planning.echeance, etat: @planning.etat, titre: @planning.titre } }
