...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { conducteur: @option.conducteur, gps: @option.gps, rehausseur: @option.rehausseur, siegebebe: @option.siegebebe } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { conducteur: @option.conducteur, gps: @option.gps, rehausseur: @option.rehausseur, siegebebe: @option.siegebebe } }
